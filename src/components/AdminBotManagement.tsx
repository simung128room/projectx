  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
            <a
                ...
                className="bg-[#09090b] text-[#10b981] px-5 py-3 font-medium hover:bg-[#10b981]/20 border border-[#10b981]/30 flex items-center gap-2 transition-all "
            >
            ...
            <button
                onClick={handleSave}
                disabled={isSaving}
                className="bg-primary text-primary-foreground text-white hover:bg-[#1D4ED8] px-6 py-3 font-medium flex items-center gap-2 transition-all"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Help Panel */}
        <div className="bg-[#09090b] border border-[#1e1e1e]  p-6 relative overflow-hidden flex flex-col space-y-4 ">
            ...
            <div className="text-muted-foreground text-sm space-y-3 leading-relaxed">
                ...
                <p>2. <strong>ติดตั้งไลบรารีที่จำเป็น:</strong> เปิด Terminal / Command Prompt แล้วพิมพ์คำสั่ง:
                   <code className="block bg-[#09090b] p-2 mt-2 rounded border border-[#1e1e1e]  text-[#10b981] ">pip install telethon httpx aiohttp cloudscraper pillow pyzbar opencv-python colorama</code>
                </p>
                ...
                <p>4. <strong>รันบอท:</strong> ใช้คำสั่ง:
                   <code className="block bg-[#09090b] p-2 mt-2 rounded border border-[#1e1e1e]  text-[#10b981] ">python bot.py</code>
                </p>
        ...
        {/* Config Editor */}
        <div className="lg:col-span-2 bg-[#09090b] border border-[#1e1e1e]  p-6 relative overflow-hidden flex flex-col ">
            ...
            <textarea
                ...
                spellCheck={false}
                className="w-full flex-1 min-h-[500px] bg-[#09090b] border border-[#1e1e1e]  p-4 text-xs font-mono text-muted-foreground focus:outline-none focus:border-[#10b981]/50 scrollbar-thin scrollbar-thumb-zinc-600 "
            />
        </div>
      </div>
    </div>
