            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input value={catName} onChange={e=>setCatName(e.target.value)} className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-2 text-white" placeholder="เช่น VIP PH LOG" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-zinc-400 mb-1">ชื่อย่อย (Subtitle)</label>
                  <input value={catSubtitle} onChange={e=>setCatSubtitle(e.target.value)} className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-2 text-white" placeholder="คำอธิบาย..." />
                </div>
                <div className="flex items-center gap-2 mt-4">
                  <input type="checkbox" id="isVipCheck" checked={catIsVip} onChange={e=>setCatIsVip(e.target.checked)} className="w-4 h-4 rounded border-zinc-800" />
                  <label htmlFor="isVipCheck" className="text-sm text-amber-400 font-bold">VIP หมวดหมู่</label>
                </div>
                <div className="flex items-center gap-2 mt-4">
                  <input type="checkbox" id="isVisibleCheck" checked={catIsVisible} onChange={e=>setCatIsVisible(e.target.checked)} className="w-4 h-4 rounded border-zinc-800" />
                  <label htmlFor="isVisibleCheck" className="text-sm text-emerald-400 font-bold">เปิดใช้งาน</label>
                </div>
              </div>
              <div className="flex justify-end gap-2 mt-4">
                ...
                <button onClick={handleSaveCategory} className="bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-2 rounded-xl text-sm font-bold flex items-center gap-2"><Check className="w-4 h-4"/> บันทึก</button>
              </div>
            </div>
          )}
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <select value={itemCategoryId} onChange={e=>setItemCategoryId(e.target.value)} className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-2 text-white">
              ...
              <div className="flex justify-end gap-2 mt-4">
                ...
                <button onClick={handleSaveItem} className="bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-2 rounded-xl text-sm font-bold flex items-center gap-2"><Check className="w-4 h-4"/> บันทึกเนื้อหา</button>
              </div>
            </div>
          )}
