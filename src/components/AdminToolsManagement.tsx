          ...
          {isAddingCategory && (
            <div className="bg-[#121212] border border-[#374151]  p-6 ">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 mt-4">
                  <input type="checkbox" id="isVisibleCheck" checked={catIsVisible} onChange={e=>setCatIsVisible(e.target.checked)} className="w-4 h-4 rounded border-[#374151] " />
                  <label htmlFor="isVisibleCheck" className="text-sm text-[#364153] font-medium">เปิดใช้งาน</label>
                </div>
              </div>
      ...
      {activeTab === 'items' && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {items.length === 0 && <div className="col-span-full py-12 text-center text-muted-foreground  border-dashed border-[#374151]">ยังไม่มีเนื้อหา</div>}
          </div>
        </div>
      )}
    </div>
