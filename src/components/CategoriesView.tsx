  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pt-24">
      <div className="flex items-center gap-4 mb-8">
        <button 
          onClick={onBack}
          className="p-3 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-full transition-colors group shadow-sm"
        >
          <ArrowLeft className="w-5 h-5 text-gray-500 group-hover:text-gray-900" />
        </button>
        <div>
          <h1 className="text-3xl sm:text-4xl font-medium text-gray-900 tracking-tight flex items-center gap-3">
             <Package className="w-8 h-8 text-[#0066ff]" /> หมวดหมู่สินค้า
          </h1>
          <p className="text-sm font-medium text-gray-500 mt-2">เลือกหมวดหมู่ที่ต้องการดูสินค้า</p>
        </div>
      </div>
