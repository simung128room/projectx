  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pt-24 font-sans text-white">
      ...
      {category !== "all" && categoryInfo?.bannerUrl && (
        <div 
          className="relative w-full rounded-md overflow-hidden border border-border bg-card mb-10 group shadow-sm"
      ...
      {!filteredProducts || filteredProducts.length === 0 ? (
        <div className=" border-dashed border-border bg-card p-16 text-center ">
                ...
                >
                  ...
                  <div className="relative aspect-square w-full bg-muted overflow-hidden shrink-0">
                    ...
                    >
                      ...
                      <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest mt-1">{product.category || "STORETH"}</span>
                    </div>
                    ...
                    {isHot && (
                      <div className="absolute top-0 right-0 overflow-hidden w-20 h-20 pointer-events-none z-10">
                        <div className="absolute top-3 -right-6 bg-card text-white text-[9px] font-semibold uppercase py-1 w-24 text-center transform rotate-45 shadow-md border-b border-border">
                          Best Seller
                        </div>
                      </div>
                    )}
                  ...
                  <div className="p-4 sm:p-5 flex flex-col flex-1 bg-card">
                    ...
                    {product.stock <= 0 ? (
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-card hover:from-blue-500 hover:to-blue-400 text-white py-2.5 rounded-md text-xs font-semibold transition-all duration-200 mt-auto shadow-md"
                      >
                    ...
                    {/* Stock Row Box */}
                    <div className="mt-3.5 py-1.5 rounded-md bg-card/[0.04] border border-border flex items-center justify-center gap-2 text-[10px] text-white/40 font-semibold uppercase tracking-widest leading-none">
          ...
          {visibleProducts.length < filteredProducts.length && (
            <div className="mt-12 flex justify-center">
              <button
                ...
                className="px-8 py-3 bg-card border border-border  hover:border-[#1f2937 text-white font-medium transition-all active:scale-95 "
              >
