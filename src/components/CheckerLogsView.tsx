  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 md:p-8 animate-in fade-in duration-500 font-sans pb-20">
      <div className="flex items-center gap-4 mb-8">
        <button 
          onClick={onBack}
          className="w-10 h-10 bg-white border border-zinc-200 rounded-full flex items-center justify-center text-zinc-500 hover:text-zinc-900 hover:bg-zinc-50 transition-all shadow-sm"
        >
      ...
      <div className="bg-white border border-zinc-200 rounded-3xl p-6 shadow-sm overflow-hidden flex flex-col h-[70vh]">
        <div className="flex items-center justify-between mb-4 pb-4 border-b border-zinc-100 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-zinc-900">Console Logs</h3>
              <p className="text-xs font-medium text-zinc-500 mt-0.5">บันทึกการทำงานล่าสุด (100 รายการ)</p>
            </div>
          </div>
        </div>

        <div className="flex-1 bg-zinc-50 border border-zinc-200 p-6 rounded-2xl text-[13px] font-mono overflow-auto scrollbar-thin scrollbar-thumb-zinc-300">
          {logs.length === 0 && (
