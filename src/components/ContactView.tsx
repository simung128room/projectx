    ...
    <div className="w-full max-w-5xl mx-auto p-4 md:p-8 animate-in fade-in duration-500 font-sans text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          {discordLink === '#' && (
            <div className="absolute top-4 right-4 bg-[#121212] text-zinc-500 text-[10px] font-bold px-2 py-1 rounded-md uppercase tracking-wide">
              เร็วๆ นี้
            </div>
          )}
        </a>
        ...
        >
          <div className="w-20 h-20 bg-[#050505]/5 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="mt-6 px-6 py-2.5 bg-[#121212] text-white rounded-xl font-bold text-sm shadow-sm group-hover:bg-[#1e1e1e] transition-colors">
            ส่งอีเมลหาเรา
          </div>
          {!contactEmail && (
            <div className="absolute top-4 right-4 bg-[#121212] text-zinc-500 text-[10px] font-bold px-2 py-1 rounded-md uppercase tracking-wide">
