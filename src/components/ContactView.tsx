    ...
    <div className="w-full max-w-5xl mx-auto p-4 md:p-8 animate-in fade-in duration-500 font-sans text-white">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8 bg-card border border-border border-2 p-6 brut-card">
        <div className="flex items-center gap-4">
          <div className="bg-primary text-primary-foreground text-blue-500 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="w-20 h-20 bg-card flex items-center justify-center mb-6 group-hover:scale-110 transition-transform brut-card">
