...
export const ContactView: React.FC<ContactViewProps> = ({ onBack, facebookLink = '#' }) => {
  return (
    <div className="w-full max-w-5xl mx-auto p-4 md:p-8 animate-in fade-in duration-500 font-sans text-zinc-900">
      <button 
        onClick={onBack}
        className="mb-6 flex items-center gap-2 text-zinc-500 hover:text-zinc-900 transition-colors font-medium bg-white px-4 py-2 rounded-xl border border-zinc-200 shadow-sm w-fit"
      >
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8 bg-white border border-zinc-200 shadow-sm rounded-3xl p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-zinc-900 tracking-tighter">ติดต่อเรา / ขอความช่วยเหลือ</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <a 
          ...
          className="bg-white border border-zinc-200 hover:border-[#5865F2] hover:shadow-md hover:shadow-[#5865F2]/10 transition-all rounded-3xl p-8 flex flex-col items-center justify-center text-center group cursor-pointer"
        >
          ...
          <h2 className="text-xl font-black text-zinc-900 mb-2">Discord Official</h2>
        ...
        <a 
          ...
          rel="noopener noreferrer"
          className="bg-white border border-zinc-200 hover:border-[#1877F2] hover:shadow-md hover:shadow-[#1877F2]/10 transition-all rounded-3xl p-8 flex flex-col items-center justify-center text-center group cursor-pointer relative overflow-hidden"
          onClick={(e) => {
            if (facebookLink === '#') {
              e.preventDefault();
            }
        ...
        >
          ...
          <h2 className="text-xl font-black text-zinc-900 mb-2">Facebook Page</h2>
          ...
          {facebookLink === '#' && (
            <div className="absolute top-4 right-4 bg-zinc-100 text-zinc-500 text-[10px] font-bold px-2 py-1 rounded-md uppercase tracking-wide">
              เร็วๆ นี้
            </div>
          )}
        </a>
