      ...
      <div className="max-w-4xl mx-auto pb-10 mt-6">
        ...
        <div className="w-full md:w-1/3 border-b md:border-b-0 md:border-r border-gray-200 p-6 flex flex-col gap-6">
          <div className="flex items-center gap-3">
             ...
             <div>
               <h2 className="text-gray-900 font-bold text-lg leading-tight">รันโทเค่นดิสอคร์ด</h2>
        ...
        <div className="w-full md:w-2/3 bg-[#0e1621] flex flex-col h-[600px] relative">
          ...
          <div className="bg-[#1c242d] px-6 py-4 flex items-center border-b border-gray-200 z-10">
            ...
            <div>
              <div className="text-gray-900 font-bold text-sm">Discord Token Status</div>
              <div className={`text-xs mt-0.5 flex items-center gap-1.5 font-medium transition-colors ${
                ...
                {status === 'connected' ? (
                  <>● Online & Working <span className="w-1.5 h-1.5 rounded-full bg-blue-600 animate-pulse"></span></>
