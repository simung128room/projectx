    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-card text-foreground flex flex-col items-center justify-center p-6 text-center ">
          ...
          <div className="bg-card p-4 border border-[#374151]  text-left w-full max-w-2xl mb-8 overflow-auto ">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-card text-foreground px-6 py-3 font-medium hover:bg-zinc-200 transition-colors "
          >
