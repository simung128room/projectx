            ...
            {step === 1 && (
              ...
              >
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="flex border border-white/10 rounded-2xl bg-[#111318] overflow-hidden focus-within:border-purple-500/50 focus-within:ring-1 focus-within:ring-purple-500/50 transition-all">
                        <div className="bg-white/5 px-3 flex items-center justify-center text-zinc-500 border-r border-white/5 font-mono text-xs shrink-0 select-none">
                          https://
                        </div>
                        <input 
                          type="text" 
                        ...
                        />
                        <div className="bg-white/5 px-3 flex items-center justify-center text-zinc-500 border-l border-white/5 font-mono text-xs shrink-0 select-none">
                          .apex.xyz
                        </div>
                      </div>
                      <p className="text-zinc-600 text-[10px] mt-2 ml-1">* อักษรภาษาอังกฤษ ตัวเลข และขีดกลาง (-) เท่านั้น</p>
                    </div>
                  </div>
                      ...
                      {THEMES.map((theme) => {
                        ...
                        return (
                          <div
                            ...
                            className={`p-4 rounded-2xl border cursor-pointer select-none transition-all ${isSelected ? 'border-purple-500 bg-purple-500/5 shadow-lg shadow-purple-500/5' : 'border-white/10 bg-black/30 hover:border-white/20'}`}
                          >
                ...
                <button
                  ...
                  className="w-full hover:-translate-y-0.5 bg-purple-600 hover:bg-purple-500 disabled:opacity-40 disabled:cursor-not-allowed disabled:transform-none text-white py-4 rounded-2xl font-bold text-sm tracking-wide shadow-lg shadow-purple-500/10 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                >
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className="lg:col-span-5 flex flex-col justify-between py-2">
                  <div>
                    <div className="w-14 h-14 bg-emerald-500/10 border border-emerald-500/25 rounded-2xl flex items-center justify-center mb-5">
                    ...
                    <div className="space-y-4 mb-8">
                      ...
                      <div className="bg-black/20 border border-white/5 rounded-2xl p-4 flex flex-col gap-2">
                        <div className="text-xs font-bold text-zinc-400 flex items-center gap-2">
                          <Layers className="w-3.5 h-3.5 text-purple-400" /> สมบัติต้นแบบที่จะได้รับ:
                        </div>
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full hover:-translate-y-0.5 bg-emerald-600 hover:bg-emerald-500 text-white py-3.5 rounded-2xl font-bold text-sm tracking-wide shadow-lg shadow-emerald-500/10 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                    >
                ...
                <div className="lg:col-span-7 flex flex-col">
                  ...
                  <div className={`w-full flex justify-center items-center p-4 bg-[#111318]/50 border border-white/10 rounded-2xl min-h-[400px] overflow-hidden`}>
                    <motion.div 
                      layout
                      className={`relative flex flex-col shadow-2xl transition-all duration-300 overflow-hidden ${selectedTheme.bgClass} ${previewDevice === 'mobile' ? 'w-[320px] h-[525px] rounded-[36px] border-[8px] border-zinc-800' : 'w-full h-[380px] rounded-xl border border-white/10'}`}
                    >
                      {/* Mobile Notch Indicator */}
                      {previewDevice === 'mobile' && (
                        <div className="absolute top-0 inset-x-0 h-5 bg-zinc-800 flex justify-center items-center z-20">
                      ...
                      <div className="flex-1 overflow-y-auto p-4 content-scroll text-left">
                        <div className="relative mb-5 p-4 rounded-xl bg-gradient-to-r overflow-hidden border border-white/5 select-none pointer-events-none">
                        ...
                        <div className={`grid ${previewDevice === 'mobile' ? 'grid-cols-2' : 'grid-cols-3'} gap-3`}>
                          {previewProducts.map((p) => (
                            <div key={p.id} className="bg-white/5 border border-white/5 p-2 rounded-xl flex flex-col justify-between h-36">
                              <div>
                                <div className="aspect-video bg-zinc-900 rounded-lg flex items-center justify-center text-[8px] text-zinc-600 font-bold mb-1.5 overflow-hidden">
