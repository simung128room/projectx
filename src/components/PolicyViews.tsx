...
export const PrivacyView: React.FC<PolicyViewProps> = ({ onBack }) => {
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -10 }}
      className="p-4 sm:p-6 md:p-10 max-w-5xl mx-auto w-full font-sans text-white pb-32"
    >
      <button
        onClick={onBack}
        className="flex items-center gap-2 text-zinc-400 hover:text-white text-sm font-medium transition-colors mb-8 cursor-pointer"
      >
      ...
      <div className="flex items-center gap-4 mb-10">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">นโยบายความเป็นส่วนตัว</h1>
          <p className="text-zinc-400 mt-1">อัปเดตล่าสุด: {new Date().toLocaleDateString("th-TH", { year: "numeric", month: "long", day: "numeric" })}</p>
        </div>
      </div>

      <div className="space-y-12">
        <section className="bg-[#121212] rounded-2xl border border-[#374151] p-6 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 text-emerald-400">1. ข้อมูลที่เราเก็บรวบรวมอย่างละเอียด</h2>
        ...
        <section className="bg-[#121212] rounded-2xl border border-[#374151] p-6 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 text-emerald-400">2. การปกป้องข้อมูล Combo และสินทรัพย์ของท่าน (Zero-Logging Assurance)</h2>
          <div className="space-y-4 text-zinc-300 text-sm leading-relaxed">
        ...
        <section className="bg-[#121212] rounded-2xl border border-[#374151] p-6 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 text-emerald-400">3. นโยบายการเปิดเผยข้อมูลแก่บุคคลที่สามอย่างรัดกุม</h2>
          <div className="space-y-4 text-zinc-300 text-sm leading-relaxed">
            <p>แพลตฟอร์มตระหนักเสมอว่าข้อมูลของคุณคือสิทธิ์ขาดของคุณ เรามีนโยบายควบคุมระดับองค์กรที่จะไม่นำข้อมูลส่วนตัว อีเมล หรือฐานข้อมูลประวัติใดๆ ของคุณไปมอบ แจกจ่าย จำหน่าย เผยแพร่ หรือแลกเปลี่ยนผลประโยชน์กับบุคคลภายนอก หรือองค์กรที่สามโดยเด็ดขาด <em>ยกเว้นในกรณีที่มีเงื่อนไขบังคับต่อไปนี้:</em></p>
        ...
        <section className="bg-[#121212] rounded-2xl border border-[#374151] p-6 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 text-emerald-400">4. สิทธิของเจ้าของข้อมูล และการติดต่อเพื่อสิทธิ</h2>
          <div className="space-y-4 text-zinc-300 text-sm leading-relaxed">
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-10">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">ข้อกำหนดและเงื่อนไขการใช้บริการ</h1>
          <p className="text-zinc-400 mt-1">อัปเดตล่าสุด: {new Date().toLocaleDateString("th-TH", { year: "numeric", month: "long", day: "numeric" })}</p>
        </div>
      </div>
      ...
      <div className="space-y-12">
        <section className="bg-[#121212] rounded-2xl border border-[#374151] p-6 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 text-rose-400">1. การรับรองความยินยอมและผูกพัน</h2>
          <div className="space-y-4 text-zinc-300 text-sm leading-relaxed">
        ...
        <section className="bg-[#121212] rounded-2xl border border-[#374151] p-6 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 text-rose-400">2. ขอบเขตสิทธิ์ หน้าที่ และการใช้งานที่ต้องห้าม (Strict AUP)</h2>
          <div className="space-y-4 text-zinc-300 text-sm leading-relaxed">
        ...
        <section className="bg-[#121212] rounded-2xl border border-[#374151] p-6 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 text-rose-400">3. ข้อตกลงแห่งการทำธุรกิจดิจิทัลและนโยบายไม่รับคืน (No Refund Principle)</h2>
          <div className="space-y-4 text-zinc-300 text-sm leading-relaxed">
        ...
        <section className="bg-[#121212] rounded-2xl border border-[#374151] p-6 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 text-rose-400">4. ข้อจำกัดความรับผิดชอบและข้อยกเว้นทางกฎหมาย (Liability Disclaimer)</h2>
          <div className="space-y-4 text-zinc-300 text-sm leading-relaxed">
        ...
        <section className="bg-[#121212] rounded-2xl border border-[#374151] p-6 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 text-rose-400">5. อำนาจสูงสุดของทีมงานระดับแอดมินิสเตรเตอร์ (Admin Absolute Authority)</h2>
          <div className="space-y-4 text-zinc-300 text-sm leading-relaxed">
            ...
            <p>ทีมงานขอใช้สิทธิ์สูงสุดที่เด็ดขาด ในการถางทาง <strong>เตะ ล็อค สั่งระงับบัญชี ขังบัญชี ทำสถานะ Void ท้ายที่สุดริบเครดิตในทันที และทำการประหาร IP Block</strong> โดยมิพักต้องเตือน ชี้แจง ร้องขอความเห็นใจ หรือรับเรื่องคำร้องจากเจ้าทุกข์แต่อย่างใด</p>
          </div>
        </section>
      </div>

      <div className="mt-16 text-center text-zinc-500 text-sm pb-8 border-b border-zinc-900">
        <p>คุณมาถึงจุดนี้ได้ นั่นหมายความว่าคุณเคารพและทำความเข้าใจมันอย่างเต็มเปี่ยม</p>
        <p className="mt-2 text-rose-400 font-medium">-- ขอให้คุณโชคดีในโลกของ APEXSTORE --</p>
      </div>
    </motion.div>
  );
};
