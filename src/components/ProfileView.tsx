...
export const ProfileView: React.FC<ProfileViewProps> = ({
  ...
  const renderHistoryItem = (item: any, type: 'purchase' | 'key') => {
    ...
    return (
      <div key={item.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 rounded-xl bg-[#0a0d12] border border-white/5 hover:border-white/10 transition-colors gap-3">
  ...
  return (
    <AnimatedScroll direction="up" hideOnScroll={true}>
      <div className="font-sans px-4 pb-12">
        <div className="bg-[#0B0F14] border-white/10 border rounded-xl w-full max-w-4xl mx-auto shadow-sm hover:shadow-md transition-shadow relative overflow-hidden flex flex-col md:flex-row mt-6">
        ...
        <div className="md:w-2/3 p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#0B0F14] border border-white/10 rounded-xl py-2.5 px-4 text-sm text-white focus:border-[#3B82F6]/50 focus:ring-2 focus:ring-[#3B82F6]/20 outline-none transition-all placeholder:text-zinc-400" 
                />
              </div>
              <div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <button type="button" onClick={() => setActiveView('history')} className="w-full flex items-center justify-between p-3 rounded-2xl bg-[#0B0F14] border border-white/10 hover:border-[#3B82F6]/30 hover:bg-[#0a0d12] transition-all group shadow-sm">
              ...
              <button type="button" onClick={() => setActiveView('redeem')} className="w-full flex items-center justify-between p-3 rounded-2xl bg-[#0B0F14] border border-white/10 hover:border-[#3B82F6]/30 hover:bg-[#3B82F6]/5 transition-all group shadow-sm">
                <div className="flex items-center gap-3">
              ...
              {user && (
                ...
                }} className="w-full flex items-center justify-between p-3 rounded-2xl bg-[#0B0F14] border border-white/10 hover:border-[#3B82F6]/30 hover:bg-[#3B82F6]/10 transition-all group shadow-sm">
                  <div className="flex items-center gap-3">
          ...
          <div className="mt-8 border-t border-white/5 pt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button className="flex items-center justify-between p-4 rounded-xl bg-[#0a0d12] border border-white/5 hover:border-[#1877F2]/30 hover:bg-[#1877F2]/5 transition-all group">
                <div className="flex items-center gap-3">
              ...
              <button className="flex items-center justify-between p-4 rounded-xl bg-[#0a0d12] border border-white/5 hover:border-[#5865F2]/30 hover:bg-[#5865F2]/5 transition-all group">
                <div className="flex items-center gap-3">
          ...
          <div className="mt-8 border-t border-white/5 pt-8">
            ...
            {purchaseHistory.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-8 bg-[#0a0d12] rounded-xl border border-white/5 border-dashed text-zinc-500">
