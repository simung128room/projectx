  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        {/* Server Info Card */}
        <div className="bg-[#121212] border border-white/10 rounded-[24px] p-8 relative overflow-hidden flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-[#050505]/50 p-4 rounded-xl border border-white/10 flex items-center justify-between">
                <div>
                ...
                <button 
                  ...
                  className="w-10 h-10 rounded-full bg-[#050505]/5 hover:bg-white/10 flex items-center justify-center text-zinc-400 hover:text-white transition-all"
                >
        ...
        <div className="bg-[#121212] border border-white/10 rounded-[24px] p-8 relative overflow-hidden flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="bg-[#050505]/50 p-6 rounded-xl border border-white/10">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="text-xs text-zinc-500 mb-6">ไฟล์ใบรับรองสำหรับติดตั้งในเครื่อง iOS</div>
                
                <a 
                  href={certLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-emerald-500/25"
                >
