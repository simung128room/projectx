      ...
      >
        ...
        <div className="bg-[#0B0D0F] border border-white/10 rounded-xl overflow-hidden shadow-xl shadow-zinc-200/50">
          <div className="grid grid-cols-1 lg:grid-cols-12 relative z-10">
            ...
            <div className="lg:col-span-12 xl:col-span-5 p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-white/10 bg-[#121212] relative overflow-hidden">
              ...
              <div className="pt-6 border-t border-white/10 relative z-10">
                ...
                <button 
                  onClick={onGoToStore}
                  className="w-full flex items-center justify-between px-5 py-4 bg-[#0a0a0a] hover:bg-[#050505] text-white rounded-xl transition-all shadow-md active:scale-[0.98] group"
                >
            ...
            <div className="lg:col-span-12 xl:col-span-7 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-[#0B0D0F] relative">
              <div className="max-w-md mx-auto w-full relative z-10">
                <div className="mb-10">
                   <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#121212] border border-white/10 text-[10px] font-bold uppercase tracking-widest text-zinc-400 mb-4">
