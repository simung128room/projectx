      ...
      {activeView === 'truemoney' && (
        ...
        >
          ...
          <div className="space-y-4">
            <div className="bg-[#121212] border border-white/10 rounded-2xl p-4 flex items-center gap-3 text-zinc-400">
              <ShieldCheck className="w-5 h-5 text-blue-500" />
              <span className="text-sm font-bold">ไม่มีค่าธรรมเนียม / ระบบอัตโนมัติ</span>
            </div>

            <div className="bg-[#121212] border border-white/10 rounded-2xl p-4 px-5 text-center">
            ...
            <form onSubmit={handleTruemoneyTopup} className="mt-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#121212] border-2 border-white/10 rounded-2xl p-4 text-white placeholder:text-zinc-400 focus:outline-none focus:border-[#2563EB] focus:bg-[#0B0D0F] transition-all font-sans font-bold"
                  required
                />
              </div>
              <button
      ...
      {activeView === 'bank' && (
        ...
        >
          ...
          <div className="space-y-6">
            <div className="bg-[#0B0D0F] border-2 border-white/10 rounded-xl p-6 text-center space-y-4 shadow-xl">
                ...
                <div className="pt-5 border-t border-white/10 flex flex-col items-center">
            ...
            <div className="pt-4 flex flex-col items-center w-full">
              <label className="flex flex-col items-center justify-center w-full py-10 bg-[#121212] hover:bg-[#121212] transition-all border-2 border-dashed border-white/20 hover:border-[#3B82F6] rounded-xl cursor-pointer group active:scale-[0.98] relative z-10">
