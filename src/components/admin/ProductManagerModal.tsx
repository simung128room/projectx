...
export const ProductManagerModal = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-[#000000]/60 backdrop-blur-3xl saturate-150 flex items-center justify-center sm:justify-end p-0 z-[100]" onClick={onClose}>
      <div 
        className="bg-[#121212] border-none sm:border-l border-[#374151] border w-full sm:max-w-md h-full relative overflow-y-auto p-6 sm:p-8 animate-in slide-in-from-bottom-full sm:slide-in-from-right-full duration-300"
        onClick={e => e.stopPropagation()}
      >
        <button onClick={onClose} className="absolute top-6 right-6 text-zinc-400 hover:text-white transition-colors bg-[#121212] p-2">
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full bg-[#121212] border border-[#374151] border px-4 py-3 text-white font-medium focus:outline-none focus:border-[#364153] focus:ring-1 focus:ring-[#364153]/50 transition-all text-sm"
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full bg-[#121212] border border-[#374151] border px-4 py-3 text-white font-medium focus:outline-none focus:border-[#364153] focus:ring-1 focus:ring-[#364153]/50 transition-all text-sm h-24 resize-none"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full bg-[#121212] border border-[#374151] border px-4 py-3 text-white/70 font-medium focus:outline-none focus:border-[#374151] transition-all text-sm"
                placeholder="0"
              />
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 p-3 bg-[#050505]/60 rounded border border-[#374151]/80 my-2">
            <input 
              type="checkbox"
              id="isPreOrder"
          ...
          {formData.isPreOrder && (
            <div className="p-3 bg-[#050505]/30 border border-[#374151]/40 rounded space-y-2 animate-in fade-in slide-in-from-top-2 duration-200">
              ...
              <input 
                ...
                className="w-full bg-[#121212] border border-[#374151] border px-3 py-2 text-white font-medium focus:outline-none focus:border-[#364153] transition-all text-xs"
          ...
          {formData.imageUrl && (
            <div className="mt-2 overflow-hidden border border-[#374151] border aspect-video bg-[#121212] relative flex items-center justify-center">
        ...
        <div className="mt-8 flex items-center gap-3">
          <button 
            onClick={onClose}
            className="flex-1 px-4 py-3 bg-[#121212] hover:bg-[#1e1e1e] text-white text-sm font-medium transition-all active:scale-95"
          >
            ยกเลิก
          </button>
          <button 
            onClick={() => {
              if(!formData.name || formData.price === '' || formData.price === null || formData.price === undefined) {
                 return Swal.fire({title: 'ข้อมูลไม่ครบ', text: 'กรุณากรอกชื่อและราคาปัจจุบัน', icon: 'warning', background: '#121212', color: '#fff'});
              }
              if (Number(formData.price) < 0) {
                 return Swal.fire({title: 'ข้อมูลไม่ถูกต้อง', text: 'ราคาไม่สามารถติดลบได้', icon: 'error', background: '#121212', color: '#fff'});
              }
              onSave(formData as Product);
            }}
            className="flex-1 px-4 py-3 bg-white text-black hover:bg-zinc-200 text-sm font-semibold transition-all active:scale-95 border border-white"
          >
