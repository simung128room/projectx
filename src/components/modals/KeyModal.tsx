...
export const KeyModal: React.FC<KeyModalProps> = ({ show, onClose, vipTab, redeemKey, userEmail }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#121212] flex items-center justify-center p-4 z-[70] font-sans animate-in zoom-in-95 duration-200 overflow-y-auto ">
      <div className="bg-[#121212] border-[#374151]  border border-[#364153]/25 p-6 sm:p-8 max-w-lg w-full relative overflow-hidden my-8 ">
        ...
        <div className="text-center mb-6 relative z-10">
            ...
            <a href="https://discord.gg/yourlink" target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-2 px-6 py-2.5 bg-[#121212] hover:bg-[#4752C4] text-white text-sm font-medium transition-all hover:scale-105 ">
          ...
          {vipTab === 'key' && (
              ...
              <div>
                  ...
                  <div className="relative">
                    ...
                    <input required name="key" type="text" className="w-full bg-[#121212] border border-[#374151]  py-3 pl-10 pr-4 text-sm focus:border-[#364153] outline-none text-white transition-all placeholder:text-zinc-400 " placeholder="APEXSTORE-XXXXX-XXXXX" />
                  </div>
              </div>
              <button type="submit" className="w-full from-[#364153] to-emerald-700 hover:from-emerald-400 hover:to-emerald-600 text-white font-medium py-3.5 transition-all mt-4">
                เปิดใช้งาน
              </button>
            </form>
          )}
        ...
        <button onClick={onClose} className="absolute top-6 right-6 text-muted-foreground hover:text-white transition-colors bg-[#121212] hover:bg-[#1e1e1e] p-2 z-20 ">
          <X className="w-4 h-4" />
        </button>
      </div>
    </div>
