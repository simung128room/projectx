      ...
      <div className="bg-[#09090b] w-full sm:max-w-[750px] sm:rounded-md relative overflow-hidden animate-in slide-in-from-bottom-full sm:zoom-in-95 duration-300 flex flex-col max-h-[95vh] ">
        ...
        <div className="pt-6 px-6 pb-4 flex items-start justify-between relative bg-[#09090b] z-10 ">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-primary text-primary-foreground flex items-center justify-center text-[#10b981]">
                  ...
                  <div className="mt-4 pt-4 border-t border-[#1e1e1e] ">
                    {!showSecret ? (
                      <button 
                        ...
                        className="w-full flex items-center justify-center gap-2 py-3 bg-primary text-primary-foreground text-[#10b981] text-xs font-semibold hover:bg-zinc-600/20 transition-colors uppercase tracking-wider"
                      >
                        ...
                        <div className="flex items-center justify-between mb-3">
                           ...
                           <div className="flex gap-2">
                             <button 
                                ...
                                className="text-[10px] font-semibold text-[#10b981] bg-primary text-primary-foreground hover:bg-zinc-600/20 px-3 py-1.5 transition-colors flex items-center gap-1.5"
                             >
